        ...
        <div className="info-container">
          ...
          <div className="parameters-box" style={{ height: '25%' }}>
            <p style={{ fontSize: '1.4rem', width: '90%' }}>
              ...
              видимих на екрані монітора, або на скануючих та друкуючих
              пристроях. Кольори представляються моделлю як результат змішення
              декількох базових (основних) кольорів, з яких вони складаються.
              Розглянуто моделі RGB та HSV
            </p>
